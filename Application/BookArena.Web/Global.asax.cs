...
namespace BookArena.Web
{
    ...
    public class DbInitializer : DropCreateDatabaseIfModelChanges<BookArenaDbContext>
    {
        protected override void Seed(BookArenaDbContext context)
        {
            ...
            new List<Category>
            {
                new Category {Id = 1, Title = "ASP"},
                new Category {Id = 2, Title = "Apple/Mac"},
                new Category {Id = 3, Title = "CMS"},
                new Category {Id = 4, Title = "CSS"},
                new Category {Id = 5, Title = "Databases"},
                new Category {Id = 6, Title = "Game Programming"},
                new Category {Id = 7, Title = "Graphics"},
                new Category {Id = 8, Title = "HTML5"},
                new Category {Id = 9, Title = "Java"},
                new Category {Id = 10, Title = "JavaScript"},
                new Category {Id = 11, Title = "Miscellaneous"},
                new Category {Id = 12, Title = "PHP"},
                new Category {Id = 13, Title = "Ruby"},
                new Category {Id = 14, Title = "Windows 8"}
            ...
            }.ForEach(book => context.Book.Add(book));
